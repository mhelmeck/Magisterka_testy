...
from utils.consts import CASE_PATTERN, PNG_IN_CASE_PATTERN
from utils.paths_definition import get_kidney_masks_dir, get_images_dir

images_dir = get_images_dir()
kidney_masks_dir = get_kidney_masks_dir()
...
def get_images_and_masks(expected_img_width, expected_img_height, start_case_index, end_case_index,
    ...
    for case_index in range(start_case_index, end_case_index + 1):
        ...
        print('Loaded data for:', CASE_PATTERN.format(case_index))

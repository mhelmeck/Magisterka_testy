...
def add_text_to_image(image, threshold, img_f1_result):
    cv2.putText(image, "Threshold: {:02f}".format(threshold), (10, 10), cv2.FONT_HERSHEY_SIMPLEX, 0.25, (255, 255, 255),
                1)
    cv2.putText(image, "F1 score: {:02f}".format(img_f1_result), (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.25,
                (255, 255, 255), 1)

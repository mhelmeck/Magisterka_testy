...
print('Started')
model_save_path = get_save_model_path('dense_unet_4_layers')
...
results = model.fit(x_train, y_train, validation_split=0.2, batch_size=batch_size, epochs=epochs, callbacks=get_callbacks(model_save_path))
